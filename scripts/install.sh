...
#
# Usage:
#   curl -fsSL https://gh.felicity.ac.cn/233laoliu/hermes-agent/hermes-agent/main/scripts/install.sh | bash
#
# Or with options:
...
REPO_URL_HTTPS="https://gh.felicity.ac.cn/https://github.com/233laoliu/hermes-agent.git"
...
detect_os() {
    case "$(uname -s)" in
        ...
        CYGWIN*|MINGW*|MSYS*)
            ...
            log_info "  irm https://gh.felicity.ac.cn/233laoliu/hermes-agent/hermes-agent/main/scripts/install.ps1 | iex"
            exit 1
            ;;
        *)
            OS="unknown"
